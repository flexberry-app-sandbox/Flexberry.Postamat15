...
namespace IIS.Postamat15
{
    ...
    public class РегистрПосылки : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Postamat15.Хранение.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрПосылкиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрПосылкиE", typeof(IIS.Postamat15.РегистрПосылки));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрПосылки : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Postamat15.DetailArrayOfРегистрПосылки members)

        // *** End programmer edit section *** (IIS.Postamat15.DetailArrayOfРегистрПосылки members)
        ...
        /// </summary>
        public DetailArrayOfРегистрПосылки(IIS.Postamat15.Хранение fХранение) : 
                base(typeof(РегистрПосылки), ((ICSSoft.STORMNET.DataObject)(fХранение)))
        {
        }
        
        public IIS.Postamat15.РегистрПосылки this[int index]
        {
            get
            {
                return ((IIS.Postamat15.РегистрПосылки)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Postamat15.РегистрПосылки dataobject)
        {
