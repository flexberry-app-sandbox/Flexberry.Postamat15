...
namespace IIS.Postamat15
{
    ...
    public class Логистика : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Postamat15.Состояние fСостояние;
        ...
        public virtual IIS.Postamat15.Состояние Состояние
        {
            get
            {
                ...
                IIS.Postamat15.Состояние result = this.fСостояние;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЛогистикаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаE", typeof(IIS.Postamat15.Логистика));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЛогистикаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЛогистикаL", typeof(IIS.Postamat15.Логистика));
                }
            }
        }
    }
